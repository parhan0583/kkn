                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="assets/assets/images/user/avatar-4.jpg" alt="user image"
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="assets/assets/images/user/avatar-2.jpg" alt="user image"
                                                        class="img-radius wid-40 align-top m-r-15">
                                                    <div class="d-inline-block">
                                            ...
                                            <td>March, 31</td>
                                            <td class="text-right">
                                                <label class="badge badge-light-primary">high</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div class="d-inline-block align-middle">
                                                    <img src="assets/assets/images/user/avatar-3.jpg" alt="user image"
                                                        class="img-radius wid-40 align-top m-r-15">
                                                    <div class="d-inline-block">
                                                        <h6>William Jem</h6>
                                            ...
                                            <td>Aug, 02</td>
                                            <td class="text-right">
                                                <label class="badge badge-light-success">medium</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <tr>
                                                    <td class="b-none">
                                                        <a href="#!" class="align-middle">
                                                            <img src="assets/assets/images/user/avatar-2.jpg"
                                                                alt="user image"
                                                                class="img-radius wid-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <h6>Jeny William</h6>
                            ...
                            <div class="review-block">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h6 class="m-b-15">
                                            John Deo
                                            <span class="float-right f-13 text-muted"> a week ago</span>
                                        </h6>
                                        <a href="#!">
                                        ...
                                        <a href="#!" class="m-r-30 text-muted">
                                            <i class="feather icon-thumbs-up m-r-15"></i>
                                            Helpful?
                                        </a>
                                        <a href="#!">
                                            <i class="feather icon-heart-on text-c-red m-r-15"></i>
                                        </a>
                                        <a href="#!">
                                            <i class="feather icon-edit text-muted"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h2>
                                        2789
                                        <span class="text-muted m-l-5 f-14">kw</span>
                                    </h2>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h2>
                                        7.3
                                        <span class="text-muted m-l-10 f-14">deg</span>
                                    </h2>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row m-b-20 received-chat">
                                ...
                                <div class="col">
                                    <div class="msg">
                                        <p class="m-b-0">Nice to meet you!</p>
                                        <img src="assets/assets/images/widget/dashborad-1.jpg" alt="">
                                        <img src="assets/assets/images/widget/dashborad-3.jpg" alt="">
                                    </div>
                                    <p class="text-muted m-b-0">
                                        <i class="fa fa-clock-o m-r-10"></i>
                                        10:20am
